    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          //       "--------------------------current User Email--------------------------",
          //     );
          //     print(AppConstants.currentUserEmail);
          //     print(AppConstants.currentUserID);
          //     // await clsPeople_data.setUnSync();
          //     // await clsDebts_data.setUnSync();
          //     // await clsPayments_data.setUnSync();
          //     // await clsTransactions_data.setUnSync();
          ...
          //     // ClsNoInternetDialog.showNoInternetDialog(context);
          //     // AppFunction.onSyncRefresh(context);
          //   },
